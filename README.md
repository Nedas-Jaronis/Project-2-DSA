...
* Dual algorithm suppport (BFS and DFS) for recommendation generation
...
> npm run dev
6. Open the application by navigating to the localhost URL displayed in your terminal

## Usage
1. Add Songs: Type your song names into the search bar and press **Enter** to add them to your playlist. If you decide you want to remove a song, simply click the button next to the song in the playlist and select **Delete Selected.**
2. View Statistics: Watch as the polar chart updates in real-time as you add songs to your playlist, displaying the average statistics.
